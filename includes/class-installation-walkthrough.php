...
class bpfwpInstallationWalkthrough {
	...
	public function __construct() {
		...
		if( ! class_exists( 'sapAdminPageSetting_2_6_15' ) ) {
			require_once BPFWP_PLUGIN_DIR . '/lib/simple-admin-pages/classes/AdminPageSetting.class.php';
		}
		
		if( !class_exists( 'sapAdminPageSettingScheduler_2_6_15' ) ) {
		...
		$this->scheduler = new sapAdminPageSettingScheduler_2_6_15( $args );
